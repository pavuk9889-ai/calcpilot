...
function generateAssistantAnswer(question) {
  ...
  if (q.includes("кредит") || q.includes("платёж") || q.includes("платеж")) {
  ...
  return "Пока я работаю в демо-режиме. Лучше всего я отвечаю на вопросы про кредиты, ипотеку, досрочное погашение, накопления, финансовую подушку и личный бюджет. Попробуйте задать вопрос чуть конкретнее.";
}
